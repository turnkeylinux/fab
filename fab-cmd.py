...
import subprocess
from typing import (
        List, Optional, Tuple, Dict, NoReturn, Union, Any, Sequence, TYPE_CHECKING
)
...
"(comments, cpp macros and already annotated packages are ignored)",
    ...
    if args.command == "query":
        ...
        cmd_plan_resolve(args.output_path, args.bootstrap_path, args.pool_path,
                args.cpp_opts, args.plan)
    elif args.command == "apply-overlay":
        cmd_apply_overlay(args.overlay, args.dstpath, args.preserve)
        ...
        if not os.path.isdir(args.root_path):
            fatal(f"root path does not exist: {args.root_path}")
